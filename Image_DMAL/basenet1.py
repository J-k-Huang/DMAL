...
class AE(nn.Module):
    def __init__(self, num_classes=345,num_layer = 2,ngf=32,norm_layer=nn.BatchNorm2d):
...
class InceptionClassifier(nn.Module):
    def __init__(self, num_classes=345,num_layer = 2):
...
class Resbridge(nn.Module):
    def __init__(self, num_classes=345,num_layer = 2,num_unit=2048,prob=0.5):
